...
const Payments = () => {
    ...
    const onBuyClicked = () => {
        ...
        const supportedInstruments = [
            {
                ...
                data: {
                    pa: products.upi2, // Replace with your Merchant UPI ID
        ...
        const details = {
            total: {
                ...
                amount: {
                    currency: "INR",
                    value: data.selling_price, // Amount to be paid
                },
            },
            displayItems: [
                {
            ...
            .then((instrument) => {
                ...
                router.push({
                    ...
                    query: {
                        ...
                        amount: data.selling_price, // Example amount
                        status: 'done',
                        date: currentDate,
                    }
                });
    ...
    const upiString = `upi://pay?pa=${encodeURIComponent(products.upi)}&am=${encodeURIComponent(data.selling_price)}`;
    return (
                    ...
                    <div className="card py-1 my-1">
                        <div className="py-2 px-3">
                            ...
                            {products.Phonepe && <div
                                ...
                                pay-type="phonepe"
                                onClick={() => {
                                    window.location.href = `phonepe://pay?pa=${products.upi}&pn=KHODIYAR%20ENTERPRISE&mc=&tn=Verified%20Merchant&am=${Number(
                                        data.selling_price
                                    )}&cu=INR&url=&mode=02&orgid=159012&mid=&msid=&mtid=&sign=MEQCIB4NcyZl2FEuktegagtryRG1iA1XG9r3tMHCIGZmR0wQAiBPvbuBFfhZjmq3MKMKH/XouOPk2+STl/VwYQTg2Y7vWg==`
                                }}
                            ...
                            {products.Paytm && <div id="divpaytm"
                                ...
                                onClick={() => {
                                    window.location.href = `paytmmp://cash_wallet?pa=${products.upi}&pn=name&mc=7692&tr=&tn=BIG&am=${data.selling_price}&cu=INR&tn=1109653558&tr=1109653558&url=&mode=02&purpose=00&orgid=159002&sign=MEQCIDsRrRTBN5u+J9c16TUURJ4IMiPQQ/Sj1WXW7Ane85mYAiBuwEHt/lPXmMKRjFFnz6+jekgTsKWwyTx44qlCXFkfpQ==&featuretype=money_transfer`;
                                }}
                            >
                                <label className="form-check-label">
                                    <img
